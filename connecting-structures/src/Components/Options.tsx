        ...
        {showObjectsOptions && (
          ...
          >
            <div className={`relative flex flex-col gap-[6px]`}>
              ...
              {showPosibilities && (
                <div
                  className={`absolute flex flex-col items-center gap-[10px] justify-center w-[200%] left-[105%] bottom-[0] bg-white rounded-[8px] shadow-[0_3px_10px_rgb(0,0,0,0.2)] overflow-hidden`}
                >
                  <div className={`text-center text-[2rem]`}>{objectName}</div>
                  <input
                    type="text"
                  ...
                  >
                    {posibilities[objectsOptions.indexOf(objectName)].map(
                      (posibility, index) => {
                        return (
                          <div key={index}>
